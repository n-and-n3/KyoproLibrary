...
int main(){
    ...
    PartiallyPersistentArray<ll> PPA = {1,2,3,4,5};
    ...
    if (PPA[0] > PPA[1]){
        cout << "PPA[0] is grater than PPA[1]" << "\n";
    } else {
        cout << "nope" << "\n";
    }

    if (PPA_copy[0] > PPA_copy[1]){
        cout << "PPA_copy[0] is grater than PPA_copy[1]" << "\n";
    } else {
        cout << "nope" << "\n";
    }
    ...
    cout << lower_bound(vall(PPA),5) - PPA.begin() << "\n";
